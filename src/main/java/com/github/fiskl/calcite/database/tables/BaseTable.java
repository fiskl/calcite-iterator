...
public class BaseTable extends AbstractTable implements ProjectableFilterableTable, DataReciever {

	private final CollectionExtractor extractor;
	private String id;
	private Map<String, Object> data;

	public BaseTable(final List<TableFieldType> fieldTypes) {
		this.extractor = CollectionExtractorFactory.create(fieldTypes);
	}
	...
	public Enumerable<Object[]> scan(
		...
		return new AbstractEnumerable<Object[]>() {
			...
			public Enumerator<Object[]> enumerator() {
				return new ListEnumerator(BaseTable.this.extractor.extractAll(
						BaseTable.this.id,
						BaseTable.this.data,
						projects));
			}
